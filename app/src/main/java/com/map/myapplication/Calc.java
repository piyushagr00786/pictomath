...
//package com.prakhar.scientificcalculator;
...
public class Calc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmic = findViewById(R.id.bmic);

        tvmain = findViewById(R.id.tvmain);
        tvsec = findViewById(R.id.tvsec);
        tvmain.setShowSoftInputOnFocus(false);
      //  disableSoftInputFromAppearing((EditText) tvmain);
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(change.contains("=")){
                        ...
                        tvmain.setText(change);
                        bequal.setOnClickListener((View.OnClickListener) this);
                    }else{
                        tvmain.setText(change);
                    }
                }
